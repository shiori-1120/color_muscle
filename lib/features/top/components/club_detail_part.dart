              ...
              child: Row(
                ...
                children: [
                  const SubClubDetail(
                      ...
                      explanation: 'アプリ開発サークルflutterを通して、ものづくり・コミュニケーションを楽しみ個人・プロジェクト活動に活かしていく!'),
                  Text(
                    '✕',
                    style:
                        TextStyle(fontSize: MediaQuery.of(context).size.width * 0.2, fontWeight: FontWeight.bold),
                  ),
                  const SubClubDetail(
                      ...
                      explanation: '「食」を通して社会をちょっとよくしたい「身近なところからフードロスを減らす」ことを目標に立ち上がったサークル！'),
                ],
              ),
            ),
          ),
